/**  
 * @Title: MaterialProgressDrawable.java
 * @Package com.reverseightning.peoplesquare.view.materialloadingprogressbar
 * @Description: TODO(用一句话描述该文件做什么)
 * @author 王磊 
 * @date 2016-7-29 上午10:28:29
 * @version V1.0  
 */ 
package com.wl.libs.widget.swipelayout;
